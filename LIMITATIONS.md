...
## What ke-osint can and cannot do

### What it does well

- **Domain recon** is reliable. WHOIS, DNS, and crt.sh are open data — results are accurate and complete for most `.ke` domains.
...
- **Phone carrier identification** is accurate for standard allocations but the CA Kenya number range database isn't publicly versioned — newly allocated prefixes may not be mapped.
